    ...
    <div class="container pt-4">
        ...
        <?php
         ...
         ?>
                ...
                <div class="card-body">
                <form action="updateWisata.php" method="post" enctype="multipart/form-data">
                <?php
                    while ($row = mysqli_fetch_array($result)){
                ?>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Title" name="title" value="<?php echo  $row['title'] ;?>" aria-label="Username"
                            aria-describedby="basic-addon1" />
                    </div>
                    <div class="input-group mb-3">
                        <input type="hidden" class="form-control" placeholder="Title" name="id" value="<?php echo  $row['id'] ;?>" aria-label="Username"
                            aria-describedby="basic-addon1" />
                    </div>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Description" name="deskripsi" value="<?php echo  $row['deskripsi'] ;?>" aria-label="Username"
                            aria-describedby="basic-addon1" />
                    </div>
